...
export function LanguageToggle() {
  ...
  const change = (next: Language) => { const params = new URLSearchParams(searchParams.toString()); if (next === "fr") params.set("lang", "fr"); else params.delete("lang"); router.replace(params.size ? `${pathname}?${params}` : pathname, { scroll: false }); };
